...
int main(){
     ...
     while(n1<0){
	  ...
	  cout<<"ERROR, este programa no calcula numeros positivos, introduzca otro: "; cin>>n1;
     ...
     while(n2<0){
	  ...
	  cout<<"ERROR, este programa no calcula numeros positivos, introduzca otro: "; cin>>n2;
